...
my_cd $homeDir/working/still/bin

# Get lsds from Tanel Poder
# https://raw.githubusercontent.com/tanelpoder/0xtools/refs/heads/master/bin/lsds
wget https://raw.githubusercontent.com/tanelpoder/0xtools/refs/heads/master/bin/lsds -O lsds
chmod u+x lsds
